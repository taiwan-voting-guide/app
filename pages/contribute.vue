<template>
  <div class="flex h-screen flex-col">
    ...
    <ContributeContent />
    <header
      class="inset-x-0 top-0 z-30 flex flex-wrap items-center justify-between gap-2 bg-slate-100/80 py-2 backdrop-blur md:flex-nowrap"
    >
      <div class="flex">
        <Logo />
        <NuxtLink
